...
- `src/pages/`: HomePage, MusicPage, TrackResultsPage and PlansPage composition; all pages reuse Header, while results and plan selection have no footer.
